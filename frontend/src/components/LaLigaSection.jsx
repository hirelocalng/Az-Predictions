...
import LaLigaCountdownTimer from './LaLigaCountdownTimer.jsx'
...
export default function LaLigaSection() {
  ...
  return (
    <section className="section" id="laliga">
      <div className="section-header">
        <div className="section-label">La Liga 2026/27</div>
        <h2 className="section-title">
          La Liga <span className="amber">Predictions</span>
        </h2>
      </div>

      <LaLigaCountdownTimer />
      ...
      {!loading && !error && fixtures.length === 0 && (
        <p style={{ textAlign:'center', color:'var(--text-muted)', padding:'40px 0' }}>
          No upcoming La Liga fixtures in the next 10 days — check back soon.
        </p>
      )}
